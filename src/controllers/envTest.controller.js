  ...
  try {
    res.status(200).json({
      ...
      data: {
        ...
        systeme: {
          apiKey: API_SYSTEME_KEY ? `${API_SYSTEME_KEY.substring(0, 8)}...` : 'Not configured',
        ...
        // Messaging & Email
        messaging: {
          sendGrid: SEND_GRID ? `${SEND_GRID.substring(0, 8)}...` : 'Not configured',
          whatsappKey: WHATSAPP_KEY ? `${WHATSAPP_KEY.substring(0, 8)}...` : 'Not configured'
        },
        
        // LLMs
        llm: {
          openaiApiKey: OPENAI_API_KEY ? `${OPENAI_API_KEY.substring(0, 8)}...` : 'Not configured',
          groqApiKey: GROQ_API_KEY ? `${GROQ_API_KEY.substring(0, 8)}...` : 'Not configured',
          geminiApiKey: GEMINI_API_KEY ? `${GEMINI_API_KEY.substring(0, 8)}...` : 'Not configured',
